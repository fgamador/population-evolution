...
export default class BinnedPopulationPhaseOutputBeakSizes {
...
populationEvolution.register( 'BinnedPopulationPhaseOutputBeakSizes', BinnedPopulationPhaseOutputBeakSizes );